#!/bin/bash
# Prospector de Sites — instala o publicador automatico (VPS) no Mac (launchd, 1x na vida).
cd "$(dirname "$0")"
PASTA="$(pwd)"
PLIST="$HOME/Library/LaunchAgents/com.prospector.publicadorvps.plist"
mkdir -p "$HOME/Library/LaunchAgents"
cat > "$PLIST" <<PLISTEOF
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0"><dict>
  <key>Label</key><string>com.prospector.publicadorvps</string>
