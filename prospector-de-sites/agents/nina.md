...
estado — é repassada pelo Orquestrador aos agentes `bruna`,
`clarice`, `cris` e `fe` como contexto.

## Não fazer

- Não escrever copy.
- Não decidir paleta/tipografia (agente `bruna`).
